...
"""4-gray grayscale for the Adafruit 2.66" SSD1680 E-Ink Display (#6392), via adafruit_epd.

296x152 ZJY panel / FPC-A003 1S ribbon. Uses Adafruit_SSD1680_Grayscale4 (colstart=0,
...
display.text('2.66" 296x152', 6, 28, Adafruit_EPD.BLACK, size=2)
display.text("4-Gray E-Ink", 6, 50, Adafruit_EPD.DARK, size=2)
display.text("SSD1680  #6392", 6, 74, Adafruit_EPD.BLACK, size=1)

# 4-level gray ramp across the bottom
RAMP_TOP, RAMP_H = 120, 26
SEG = W // 4
